/*
 * Public API Surface of tpp-cookie-consent
 */
...
export * from './lib/types/tpp-banner-button';
export * from './lib/types/tpp-banner-link';
export * from './lib/types/tpp-status-changed-event';